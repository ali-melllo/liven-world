                                        ...
                                        <CardContent className="p-4 space-y-3">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex-1">
                                                    <h3 className="font-semibold text-sm">{post.type === "looking_for_help" ? "Looking For Help" : post.type === "offering_help" ? "Offering Help" : ""}</h3>
                                            ...
                                            <div className="flex items-center gap-4 pt-2">
                                                <button
                                                    ...
                                                    className={`flex items-center gap-2 transition-colors ${post.likes?.includes(userId) ? "text-red-500" : "text-muted-foreground hover:text-red-500"
                                                        }`}
                                                >
                                                    <Heart className={`h-4 w-4 ${post.likes?.includes(userId) ? "fill-current" : ""}`} />
                                                    <span className="text-sm">{post.likes.length}</span>
                                                </button>
                                                <CommentsDrawer postId={post._id} commentCount={Number(post.commentCount)} postTitle={post.type === "looking_for_help" ? "Looking For Help" : post.type === "offering_help" ? "Offering Help" : ""} />
                                            </div>
                                        </CardContent>
                                    </Card>
                                ))}
